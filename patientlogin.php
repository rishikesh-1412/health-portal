...
<div class="wrapper col2">
	<div id="breadcrumb">
		<ul>
			<li class="first">Pateint Login panel</li>
		</ul>
  </div>
</div>
...
<div class="wrapper col4">
  	<div id="container">
    	<h1>Kindly login through Login ID and Password.</h1>
      			...
      			<tbody>
        			...
        			<tr>
          				<td height="36" colspan="2" align="center">
							  <strong>New user<br><a href="patient.php">Click Here</a> to Register </strong> | <a href="patientforgotpassword.php"><strong>Forgot Password</strong></a>
						</td>
        			</tr>
      			</tbody>
    		</table>
