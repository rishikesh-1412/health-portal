...
<div class="wrapper col2">
  <div id="breadcrumb">
    <ul>
      <li class="first">View Patient records</li>
    </ul>
  </div>
</div>
                ...
                echo 
                  "<tr>
                    <td>$rs[patientname]<br>
                      <strong>Login ID :</strong> $rs[loginid] 
                    </td>
                    <td>
                      <strong>Date</strong>: &nbsp;$rs[admissiondate]<br>
                      <strong>Time</strong>: &nbsp;$rs[admissiontime]
                    </td>
                    ...
                    <td><strong>Blood group</strong> - $rs[bloodgroup]<br>
                      ...
                      <strong>DOB</strong> - &nbsp;$rs[dob]
                    </td>
                    <td align='center'>Status - $rs[status] <br>";
                      if(isset($_SESSION[adminid])){
                        echo "<a href='patient.php?editid=$rs[patientid]'>Edit</a> | <a href='viewpatient.php?delid=$rs[patientid]'>Delete</a><br/>
                          <a href='patientreport.php?patientid=$rs[patientid]'>View Report</a><hr/>";
                      }
                      echo "
                    </td>
                  </tr>";
