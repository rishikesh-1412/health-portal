  ...
  <input type="hidden" name="prescriptionid" value="<?php echo $_GET[prescriptionid]; ?>"  />
    <table width="200" border="3">
      <tbody>
        ...
        <tr>
          <td>Unit</td>
          <td><input type="number" min="1" name="unit" id="unit" value="<?php echo $rsedit[unit]; ?>" onchange="calctotalcost()" onchange="" /></td>
        </tr>
        <tr>
          <td>Total Cost</td>
          <td><input type="text" name="totcost" id="totcost" value="0" readonly style="background-color:pink;" /></td>
        </tr>
        <tr>
          <td>Dosage</td>
...
function calctotalcost()
{
	...
	document.getElementById("totcost").value = a*b;
} 
